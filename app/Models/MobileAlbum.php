...
class MobileAlbum extends Model
{
    use SoftDeletes;
    ...
    {
        return MobileAlbum::validator()->fails();
    }

    public static function has_invalid_quick_edit_data()
    {
        return MobileAlbum::quick_edit_validator()->fails();
    }

    public static function get_error_messages()
    {
        return MobileAlbum::validator()->messages();
    }

    public static function get_quick_edit_error_messages()
    {
        return MobileAlbum::quick_edit_validator()->messages();
    }
    ...
    {
        $total = MobileAlbum::where('type','sub_banner')->withTrashed()->get()->count();
    ...
    {
        $total = MobileAlbum::where('type','sub_banner')->count();
    ...
    {
        $withTrashed = MobileAlbum::withTrashed()->get()->count();
        $total = $withTrashed - MobileAlbum::count();
