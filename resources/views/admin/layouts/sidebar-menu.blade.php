<ul class="nav nav-aside">
    ...
    <!-- <li class="nav-item with-sub @if (request()->routeIs('resources*') || request()->routeIs('resource-categories*')) active show @endif" style="@if(auth()->user()->role_id != '1') display: none; @endif">
        ...
        <ul>
            ...
            <li style="display: none;" @if (\Route::current()->getName() == 'resource-categories.index' || \Route::current()->getName() == 'resource-categories.edit') class="active" @endif>
                <a href="{{ route('resource-categories.index') }}">Manage Categories</a>
            </li>
