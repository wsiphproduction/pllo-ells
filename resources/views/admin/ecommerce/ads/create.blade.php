    ...
    <div class="container pd-x-0">
        <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
            <div>
                ...
                <h4 class="mg-b-0 tx-spacing--1">Create Ad </h4>
            </div>
        </div>

        <form id="createForm" method="POST" action="{{ route('ads.store') }}" enctype="multipart/form-data">
            <div class="row row-sm">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <input name="expiration_date" id="expiration_date" value="{{ old('expiration_date') }}" required type="date" class="form-control @error('expiration_date') is-invalid @enderror">
                ...
                <div class="col-lg-12 mg-t-30">
                    <input class="btn btn-primary btn-sm btn-uppercase" type="submit" value="Save Ad">
