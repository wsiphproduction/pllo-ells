                        ...
                        <table class="table mg-b-0 table-light table-hover" style="table-layout: fixed;word-wrap: break-word;">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 10%;">Congress</th>
                                    <th style="width: 10%;">RA / JR Number</th>
                            ...
                            @forelse($files as $file)
                                ...
                                <tr id="row{{$file->id}}">
                                    ...
                                    <td><strong @if($file->trashed()) style="text-decoration:line-through;" @endif>{{$file->title}}</strong></td>
                                    <td>{{$file->congress}}</td>
                                    <td>{{$file->ra_jr}}</td>
                                    <td>{{$file->approved_on}}</td>
