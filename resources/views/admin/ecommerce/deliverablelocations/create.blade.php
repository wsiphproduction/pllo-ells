        ...
        <div class="col-md-6">
            <form id="delivery_form" autocomplete="off" action="{{ route('locations.store') }}" method="post">
                    ...
                    <div class="form-group" id="region_div">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" maxlength="150" value="{{ old('name') }}">
                        @error('name')
                    ...
                    <div class="form-group" id="region_div">
                        ...
                        <input type="number" class="form-control @error('rate') is-invalid @enderror text-right" name="rate" id="rate" min="1" step="0.01" value="{{ old('rate',0.00) }}"> 
                        @error('rate')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror                                       
                    </div>  
