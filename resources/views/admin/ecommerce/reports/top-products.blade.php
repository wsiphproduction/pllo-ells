...
<div style="margin: 40px 40px 200px 40px;font-family:Arial;">
    ...
    <form action="{{route('report.top-products')}}" method="get">
        ...
        <table style="font-size:12px;">
            ...
            <tr>
                ...
                <td><a href="{{ route('report.top-products') }}" class="btn btn-sm btn-success" style="margin:0px 0px 0px 5px;">Reset</a></td>
            </tr>
        </table>
    </form>
