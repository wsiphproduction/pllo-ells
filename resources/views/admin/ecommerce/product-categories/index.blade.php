            ...
            <div class="col-md-3">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <form method="post" action="{{ route('reorder-product-category') }}">
                            @csrf
                        <div class="list list-row" id="sortable" data-sortable-id="0" aria-dropeffect="move">
                            @foreach($parentCategories as $cat)
                            <div class="list-item" data-id="{{$cat->id}}" data-item-sortable-id="0" draggable="true" role="option" aria-grabbed="false" style="border: 1px solid #F5894E; margin-bottom: 5px;">
                                <div class="flex">
                                    <input type="hidden" name="order_no[]" value="{{$cat->id}}">
                                    <a href="#" class="item-author text-dark" data-abc="true"><strong>{{$cat->name}}</strong></a>
                                </div>
                            </div>
                            @endforeach
                            <br>
