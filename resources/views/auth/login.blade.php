...
<body id="scroll1">
    ...
    <div class="content-auth">
        <div class="row no-gutters">
            ...
            <div class="col-lg-6" style="background-color: #151c27;">
                <div class="sign-wrapper">
                    <div class="wd-100p">
                        <h3 class="mg-b-3 text-white">Log In</h3>
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                                <label class="text-white" for="email"><i class="tx-danger">*</i> Email</label>
                            ...
                            <div class="form-group {{ $errors->has('password') ? 'has-error' : '' }}">
                                <label class="text-white" for="password"><i class="tx-danger">*</i> Password</label>
