    ...
    <div style="max-width: 700px; width: 100%; background: #fff;margin: 30px auto;">
        ...
        <div style="padding:30px 60px;">
            ...
            <div style="text-align: center;">
                <a href="{{ route('home') }}" target="_blank" style="padding: 10px 20px; background: #3b5d90; color: #fff;text-decoration: none;font-size: 14px; border-radius: 3px;">COMPLETE PROFILE </a>
            </div>
