...
<div style="max-width: 700px; width: 100%; background: #fff;margin: 30px auto;">
    ...
    <div style="padding:30px 60px;">
        ...
        <div style="text-align: center;">
            @if($user->role_id == 2)
                <a href="{{ route('member.reset-password', $token) }}?email={{ $user->email }}&user=new" target="_blank" style="padding: 10px 20px; background: #0349fc; color: #fff;text-decoration: none;font-size: 14px; border-radius: 3px;">Activate my account</a>
            @else
