...
<body>
    ...
    <div style="max-width: 700px; width: 100%; background: #fff;margin: 30px auto;">
        ...
        <div style="padding:30px 60px;">
            ...
            <p>
                <b>Welcome to {{ $setting->company_name }}</b>
            </p>
            <p>
                Hi, {{ $user->name }}!
            </p>
            ...
            <div style="text-align: center;">
                <a href="{{ route('confirm.email') }}?email={{ $user->email }}" target="_blank" style="padding: 10px 20px; background: #3b5d90; color: #fff;text-decoration: none;font-size: 14px; border-radius: 3px;">CONFIRM EMAIL</a>
            </div>
