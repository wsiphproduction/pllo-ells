...
<title>User Cluster Modified</title>
...
<body>
    ...
    <div style="max-width: 700px; width: 100%; background: #fff;margin: 30px auto;">
        ...
        <div style="padding:30px 60px;">
            ...
            <p>
                This is to inform you that a user has modified their assigned cluster, and the changes are now pending your review and approval.
            </p>
            ...
            <div style="text-align: center;">
                <a href="{{ route('admin.dashboard') }}" target="_blank" style="padding: 10px 20px; background: #3b5d90; color: #fff;text-decoration: none;font-size: 14px; border-radius: 3px;">GO TO ADMIN DASHBOARD</a>
            </div>
