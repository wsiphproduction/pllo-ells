		...
		<div class="container">
			...
			<div class="row p-4 mt-4">
				<div class="col-12 mb-5">
					<h3 class="form-title m-5">PREVIOUS EVENTS</h3>
					...
					<div id="portfolio" class="row g-4">
											...
											<div class="col-md-8">
												<div class="card-body">
													...
													<ul class="list-unstyled mb-2 small">
														...
														<li><i class="bi-calendar-event me-2"></i>Date: {{ \Carbon\Carbon::parse($prev_event->date)->format('Y M d') .' at '. $prev_event->time}}</li>
						...
						@if($show_event == 0)
							<div class="col-10 offset-1 promo promo-light p-4 p-md-5 mb-5">
