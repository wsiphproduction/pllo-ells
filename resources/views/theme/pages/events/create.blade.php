							...
							<div class="row form-group">
								<div class="col-12">
									...
									<div id="agency-container" class="form-group" style="margin-top: -57px;">
										<small class="col-sm-12 text-uppercase">Agency</small>
										<div class="row agency-row">
											...
											<div class="col-sm-2 participant-limit" style="display: none;">
												<input class="form-control" name="participant_limit[]" type="number" min="0" onclick="select()" oninput="this.value = this.value || 0;" value="10" placeholder="LIMIT">
											</div>
										</div>
									</div>
									...
									<div class="form-group row" style="margin-top: -7px;">
										<div class="col-5 text-end">
											<button class="form-control bg-dark text-white" type="button" id="add-agency">ADD ANOTHER AGENCY</button>
										</div>
										<div class="col-sm-5">
										...
										<div class="col-sm-2" id="universal-limit-wrapper">
											<input class="form-control" type="number" id="universal-limit" title="Set limit for all" min="0" onclick="select()" oninput="this.value = this.value || 0;" value="10" placeholder="SET LIMIT FOR ALL">
										</div>
									</div>
		...
		$(document).ready(function () {
			...
			$('#add-agency').on('click', function () {
				...
				<div class="row agency-row" style="margin-top: 10px;">
					...
					<div class="col-sm-2 participant-limit" style="display: none;">
						<input class="form-control" name="participant_limit[]" type="number" value="10" placeholder="LIMIT">
					</div>
				</div>`;
