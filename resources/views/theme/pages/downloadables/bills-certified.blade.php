...
@section('content')
    <div class="container">
        ...
        <div class="col-12 mb-0">
            ...
            <div class="row mt-4">
                <div class="col-8">
                    <form method="get" action="{{ route('downloads.bills-certified') }}">
                        <div class="d-flex align-items-center">
                            ...
                            <select class="form-control me-2" name="source_priority_level">
                                ...
                                @foreach ($bills_certified->pluck('source_priority_level')->unique()->filter()->sort() as $level)
                            ...
                            <a href="{{ route('downloads.bills-certified') }}" type="button" class="btn btn-light btn-outline-success me-1">Clear</a>
                ...
                <div class="modal-body">
                    ...
                    <div class="row mt-3">
                        <form id="creation_form" action="{{ route('downloads.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="d-block">Bill No. Reference *</label>
                                <input type="text" name="bill_no" id="bill_no" value="{{ old('bill_no')}}" class="form-control @error('bill_no') is-invalid @enderror" maxlength="150" required>
                                @error('bill_no')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
