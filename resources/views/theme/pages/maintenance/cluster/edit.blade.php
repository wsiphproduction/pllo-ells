        ...
        <div class="col-lg-12">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-10 border rounded shadow" style="padding: 20px;">
                    ...
                    <div class="cluster-maintenance-add border-top">
                        <h5 class="mt-3 mb-0" style="opacity: .8;">Edit Cluster</h5>
                        <small style="opacity: .8;">Edit details on coresponding field below.</small>

                        <div class="create-cluster-container mt-3">
                            <form class="m-0" method="post" action="{{ route('maintenance.cluster.update', $cluster->id) }}" enctype="multipart/form-date">
                                @csrf
                                <div class="d-flex flex-column flex-md-row">
                                    ...
                                    <div class="col-12 col-md-6 px-4">
                                        ...
                                        <div class="d-flex align-items-center justify-content-start gap-3 py-4">
                                            ...
                                            <a href="{{ route('maintenance.cluster') }}" id="btn-cancel-cluster-edit" class="btn btn-secondary">
                                                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
