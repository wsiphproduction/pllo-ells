    ...
    <div class="container">
        ...
        <div class="row mb-5">
            ...
            <div id="oc-team" class="owl-carousel team-carousel carousel-widget" data-margin="30" data-nav="true" data-pagi="true" data-items-xs="1" data-items-sm="1" data-items-lg="2" data-items-xl="2">
                ...
                <!-- Proposed Bills -->
                @php
                    $bills = App\Models\PolicyReform::limit(5)->get();
                @endphp
                    @foreach($bills as $bill)
                    <div class="card mb-4 p-3 border-0 shadow-sm">
                        <div class="row g-0">
                            <div class="col-md-4" style="height: 200px;">
                                <img src="{{ asset('') . $bill->photo }}" onerror="this.onerror=null; this.src='{{ asset('theme/addons/images/logos/pllo-logo.png') }}';"
                                    class="img-fluid rounded-start"
                                    style="height: 100%; width: 100%; object-fit: contain;"
                                    alt="Proposed Bill">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h6 class="card-title mb-2 text-primary fw-bold">{{ $bill->title }}</h6>
                                    <ul class="list-unstyled mb-2 small">
                                        <li><i class="bi-file-earmark-text me-2"></i>{{ $bill->policyReformCategory->name }}</li>
                                        <li><i class="bi-calendar-event me-2"></i>Filed: {{ date('F d, Y', strtotime($bill->created_at)) }}</li>
                                        <li><i class="bi-person me-2"></i>Author: {{ $bill->member->FullName }}</li>
                                    </ul>
                                    <p class="card-text small text-muted mb-2">
                                        {{ $bill->description }}
                                    </p>
                                    <div class="text-end">
                                        <a href="{{ env('APP_URL') }}/policy-reform-view/{{ $bill->category }}" class="fw-semibold small text-decoration-none text-primary">VIEW BILL <i class="bi-arrow-right-short align-middle"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
